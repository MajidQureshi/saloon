...
class CalendarController extends Controller
{
    public function index()
    {
        ...
        $employees = Employee::where('salon_id', $salon->salon_id)->get();
        ...
        $calendar = Calendar::addEvents($event)->setCallbacks(['eventClick' => 'eventClicked','select'=>'dateClick'])->setOptions(['selectable'=>true]);
        return view('owner.pages.calendar', compact('give_service','booking','calendar','users','services', 'employees'));
    }
    public function empCalendar(Request $request)
    {
        ...
        $bookings = Booking::where('salon_id',$salon->salon_id)->where('emp_id', $emp_id)->get();
        $ar = array();
        foreach ($bookings as $user)
        {
            array_push($ar,$user->user_id);
        ...
        $salon_id = $salon->salon_id;
        $give_service = $salon->give_service;
        $booking = Booking::where('salon_id',$salon_id)->where('emp_id', $emp_id)->get();
        ...
        return view('owner.component.calendar', compact('calendar'));
    }
