...
Route::group([
    ...
    //added by anoop
    Route::get('/subscribe', 'website\WebsiteController@subscribe');
    Route::get('/choose-subscription/{id}', 'website\WebsiteController@chooseSubscription')->name('choose-subscription');
...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/subscriptions/{id}', 'admin\SubscriptionController@show');
    Route::post('/subscriptions/create', 'admin\SubscriptionController@create');
    Route::post('/subscriptions/store', 'admin\SubscriptionController@store');
    Route::get('/subscriptions/edit/{id}', 'admin\SubscriptionController@edit');
    Route::post('/subscriptions/update/{id}', 'admin\SubscriptionController@update');
    Route::get('/subscriptions/delete/{id}', 'admin\SubscriptionController@destroy');
    Route::post('/subscriptions/hideSubscription', 'admin\SubscriptionController@hideSubscription');
    Route::get('/subscriptions-features/load/{id}', 'admin\SubscriptionController@loadSubscriptionFeature');
    Route::post('/subscriptions-features/store', 'admin\SubscriptionController@subscriptionFeatureStore');

    Route::get('/sub-features', 'admin\SubscriptionController@subFeatures');
    Route::post('/hide-sub-feature', 'admin\SubscriptionController@hideSubFeature');
    Route::post('/sub-features/store', 'admin\SubscriptionController@subFeatureStore');
    Route::get('/load-subscriptions', 'admin\SubscriptionController@loadSubscriptions');


    Route::get('/sub-features/edit/{id}', 'admin\SubscriptionController@editSubFeature');
...
Route::prefix('owner')->middleware(['auth', 'owner'])->group(function () {
    ...
    Route::get('/empCalendar', 'owner\CalendarController@empCalendar')->name('empCalendar');
