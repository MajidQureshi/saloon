...
<html lang="en">
    ...
    <img class="nav__menu" src="{{asset('html-assests/shared/menu.svg')}}" alt="" />
        ...
        @php
                ...
                <h2
                    class="subscription__checkout-title subscription__checkout-title--plat"
                >
                    Yearly Platinum
                </h2>
                <p
                    class="subscription__checkout-text subscription__checkout-text--plat"
                >
                ...
                <span class="subscription__checkout-new_price">3600 AED</span>
            </div>
