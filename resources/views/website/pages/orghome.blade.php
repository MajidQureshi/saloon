...
<header class="header--home">
    ...
    <form class="header--home__form" action="">
        <div class="form__container">
            <div class="form__input__container">
                <label class="form__input__search__label"></label>
                <input class="header--home__input" placeholder="What are you looking for ?" type="text" />
            </div>
            <div class="form__input__container">
                <label class="form__input__pin__label"></label>
                <input class="header--home__input" placeholder="Where to look ?" type="text" />
            </div>
    ...
    <div class=" appointment__content">
        ...
        <form class="appointment__form" action="">
            <div class="appointment__form__box">
                ...
                <input class="appointment__form__input" type="text" placeholder="What are you looking for ?" />
            </div>
            <div class="appointment__form__box">
                <label class="appointment__form__label--pin" for=""></label>

                <input class="appointment__form__input" type="text" placeholder="Where to look ?" />
            </div>
            <div class="appointment__form__box">
            ...
            <div class="form__buttons">
                <button class="form__buttons__search">Search</button>
                <a href="" class="form__buttons__subscribe">
                    Subscribe Now
                </a>
            </div>
        </form>
...
<section class="carousel__section">
    ...
    <div class="carousel__section__carousel">
        ...
        <div class="carousel__section__button-container">
            <a href=""><button class="carousel__section__button">
                    See More
                    <span></span>
                </button>
            </a>
