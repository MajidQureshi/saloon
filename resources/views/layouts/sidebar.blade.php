<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            {{-- added by anoop  --}}
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/subscriptions*')  ? 'active' : ''}}" href="{{url('admin/subscriptions')}}">
                    <i class="fas fa-asterisk text-blue"></i>
                    <span class="nav-link-text">{{__('Subscription')}}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/sub-features*')  ? 'active' : ''}}" href="{{url('admin/sub-features')}}">
                    <i class="fas fa-asterisk text-blue"></i>
                    <span class="nav-link-text">{{__('Subscription Features')}}</span>
                </a>
            </li>
            ...
            href="#navbar-examples" data-toggle="collapse" aria-expanded="
            {{ request()->is('admin/notification*')  ? 'true' : ''}}" role="button" aria-controls="navbar-examples">
            ...
            {{-- <li class="nav-item">
                        <a class="nav-link {{ request()->is('admin/module*')  ? 'active' : ''}}"
            href="{{url('admin/module')}}">
        ...
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item">
                        <a class="nav-link {{ request()->is('owner/report*')  ? 'active_text' : ''}}"
            href="#navbar-examples1" data-toggle="collapse" aria-expanded="
            {{ request()->is('owner/report*')  ? 'true' : ''}}" role="button" aria-controls="navbar-examples">
