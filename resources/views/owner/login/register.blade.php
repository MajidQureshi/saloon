                            ...
                            <div class="form-wrap">
                                ...
                                @csrf
                                    ...
                                    <div class="pui-form__element">
                                        ...
                                        <input id="inputPhone" type="number" maxlength="10" class="form-control {{ old('phone') != null ? 'outline': '' }}  @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="" autocomplete="mobile">
