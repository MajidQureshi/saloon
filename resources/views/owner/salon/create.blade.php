                                                    ...
                                                    <div class="p-20">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{old('name')}}" name="name" id="name" class="form-control" placeholder="{{__('name should be match with license')}}"  autofocus>
                                                                @error('name')                                    
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-control-label" for="license_image">{{__('License Image')}}</label><br>
                                                                <input type="file"  value="{{old('license_image')}}" id="license_image" name="license_image" accept="image/*" onchange="loadFile6(event)" ><br>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="form-control-label" for="id_card">{{__('ID Card')}}</label><br>
                                                                <input type="file"  value="{{old('id_card')}}" id="id_card" name="id_card" accept="image/*" onchange="loadFile5(event)" ><br>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group col-6 give_service_class">
                                                                <label class="form-control-label">{{__('Do You Have Website ?')}}</label><br>
                                                                <div class="custom-control custom-radio mb-2">
                                                                    <input type="radio" id="have_website" name="have_website" value="yes" class="custom-control-input">
                                                                    <label class="custom-control-label" for="have_website">{{__('Yes')}}</label>
                                                                </div>
                                                                <div class="custom-control custom-radio mb-2">
                                                                    <input type="radio" id="not_have_website" name="have_website" value="no" class="custom-control-input">
                                                                    <label class="custom-control-label" for="not_have_website">{{__('No')}}</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" maxlength="10" value="{{old('phone', Auth::user()->phone)}}"  class="form-control" name="phone" id="phone" placeholder="{{__('Phone Number')}}" >
                                                                @error('phone')                                    
                                                                    <div class="invalid-div">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="p-20">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="address" name="address" placeholder="{{__('Address of salon')}}" value="{{old('address')}}">
                                                                @error('address')                                    
                                                                    <div class="invalid-div">{{ $message }}</div>
                                                                @enderror
                                                            </div>
