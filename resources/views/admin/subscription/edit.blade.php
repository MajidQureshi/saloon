<div class="container-fluid sidebar_open @if($errors->any()) show_sidebar_edit @endif" id="edit_subscription_sidebar">
    <div class="row">
        <div class="col">
            <div class="card py-3 border-0">
                <div class="border_bottom_pink pb-3 pt-2 mb-4">
                    <span class="h3">{{__('Edit Subscription')}}</span>
                    <button type="button" class="edit_subscription close">&times;</button>
                </div>
                <form class="form-horizontal" id="edit_subscription_form" action="#" method="post">
                    @csrf
                    <div>
                        ...
                        <div class="text-center">
                            <button type="button" onclick="all_edit('edit_subscription_form','subscriptions')"
